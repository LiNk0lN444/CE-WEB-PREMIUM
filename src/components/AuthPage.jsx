...
export default function AuthPage({ onLoginSuccess, onCancel }) {
    ...
    const handleLoginSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            // Consultamos directamente la lista de usuarios registrados
            ...
            // Permitimos el acceso directo con el usuario encontrado
            if (onLoginSuccess) {
            ...
            <div className="auth-card">
                ...
                {isLogin ? (
                    <form className="auth-form" onSubmit={handleLoginSubmit}>
                        ...
                        {onCancel && (
                            <button type="button" className="cot-btn-secundario" onClick={onCancel} style={{ marginTop: '0.5rem', width: '100%', cursor: 'pointer' }}>
                                Volver al Inicio
                            </button>
                        )}
                    </form>
